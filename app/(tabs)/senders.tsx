...
export default function SendersScreen() {
  ...
  const handleLogin = async () => {
    try {
      ...
      setNotice("Secure sign-in is not configured in this preview. Add the approved OAuth portal configuration before using real accounts.");
    }
  };
